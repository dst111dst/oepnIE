...
def calculate_f1(output_dir):
    ...
    task_path = os.path.join(output_dir, 'predict_eval_results.json')
    task_path = '/root/InstructUIE/output/test/predict_eval_predictions.json'
...
if __name__ == '__main__':
    root = '/root/InstructUIE/output/test'
