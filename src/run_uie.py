...
def main():
    ...
    if os.path.isdir(training_args.output_dir) and training_args.do_train and not training_args.overwrite_output_dir:
        ...
        # last_checkpoint = get_last_checkpoint('output/test/checkpoint-14000')
    ...
    input_record_file = 'flan-t5-small.record'
    
    data_args = argparse.ArgumentParser()
    data_args.input_record_file = input_record_file
    ...
    data_args.max_train_samples = max_train_samples
    ...
    data_args.ignore_pad_token_for_loss = ignore_pad_token_for_loss
    data_args.add_task_name = add_task_name
    data_args.add_dataset_name = add_dataset_name
    data_args.common_dataset_name = common_dataset_name
    data_args.over_sampling = over_sampling
    data_args.max_target_length = max_target_length
    data_args.num_examples = num_examples
    data_args.repetition_penalty = 1.0
    ...
    # model_args.model_name_or_path = '/root/.cache/huggingface/hub/models--ZWK--InstructUIE'
    model_args.model_name_or_path = '/root/autodl-tmp/llama2'
    # model_args.resume_from_checkpoint = '/root/InstructUIE/output/test/checkpoint-8000'
    
    config = AutoConfig.from_pretrained(
        # '/root/InstructUIE/output/test',
        # '/root/InstructUIE/output/flan-t5-small',
        '/root/autodl-tmp/llama2',
